...
public class SimulatorApplication extends javafx.application.Application {
  ...
  public static final int INITIAL_MOTORIZED_FIREFIGHTER_COUNT = 3;
  ...
  private void initializeView() throws IOException {
    ...
    controller.initialize(BOX_WIDTH, BOX_HEIGHT, COLUMN_COUNT, ROW_COUNT,
            INITIAL_FIRE_COUNT, INITIAL_FIREFIGHTER_COUNT, INITIAL_MOTORIZED_FIREFIGHTER_COUNT, INITIAL_MOUNTAIN_COUNT);
  }
